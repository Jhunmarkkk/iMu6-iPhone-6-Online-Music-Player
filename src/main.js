...
function createPlaylist(trackId) { pendingPlaylistTrack = trackId || null; var modal = document.querySelector('#playlist-modal'); var input = document.querySelector('#playlist-name'); modal.hidden = false; input.value = ''; window.setTimeout(function () { input.focus() }, 250) }
